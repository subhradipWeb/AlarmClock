...
function changeBackground() {
    ...
    if (dth >= 12 && dth < 20) {
        document.body.style.backgroundImage = "linear-gradient(rgb(0,0,0,0.6),rgb(0,0,0,0.4)), url(Afternoon.jpg)";
        console.log('work')
    } else if (dth >= 20) {
        document.body.style.backgroundImage = "linear-gradient(rgb(0,0,0,0.6),rgb(0,0,0,0.4)), url(night.jpg)";
        console.log('ikjkij')
    }
